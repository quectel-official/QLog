...
int ql_find_quectel_modules(void)
{
    ...
    while (NULL != (usb = readdir(usb_dir)))
    {
        ...
        if ((ql_dev.idVendor == 0x3763 && ql_dev.idProduct == 0x3c93) || (ql_dev.idVendor == 0x3c93 && ql_dev.idProduct == 0xffff))
        {
        ...
        strncpy(ql_dev.devname, get_value_from_uevent(devpath, "DEVNAME"), sizeof(ql_dev.devname) - 1);
        ...
        {            
            if (ql_dev.idVendor == 0x05c6 && ql_dev.idProduct == 0x90db)
            {
        ...
        if ((ql_dev.idVendor == 0x2c7c && ql_dev.idProduct == 0x0127)     // EM05CEFC-LNV       Laptop
            || (ql_dev.idVendor == 0x2c7c && ql_dev.idProduct == 0x0128)  // EM060KGL Google    Laptop
    ...
    _rescan_dm:
        ...
        if (ql_dev.dm_intf.bInterfaceNumber == 0 && ql_dev.dm_intf.bInterfaceClass == 0x02 && ql_dev.dm_intf.bInterfaceSubClass == 0x0e)
        { // EM05-G 's interface 0 is MBIM
            ql_dev.dm_intf.bInterfaceNumber = 3;
            goto _rescan_dm;
        }
        ...
        if (ql_dev.general_intf.bInterfaceNumber != 0xFF && (ql_dev.general_type == EC200U_AP || ql_dev.general_type == RG500U_LOG))
        {
        ...
        else if (ql_dev.general_intf.bInterfaceNumber != 0xFF && ql_dev.general_type == MDM_QDSS)
        {
            ...
            {
                ql_find_usb_interface_info(devpath, &ql_dev.general_intf);
                if (ql_dev.general_intf.bInterfaceClass != 0xff || ql_dev.general_intf.bInterfaceSubClass != 0xff || ql_dev.general_intf.bInterfaceProtocol != 0x70 || ql_dev.general_intf.bNumEndpoints != 1 || ql_dev.general_intf.ep_out != 0xff || ql_dev.general_intf.ep_in == 0xff)
                {
        ...
        else if (ql_dev.third_intf.bInterfaceNumber != 0xFF && ql_dev.third_type == 1)
        {
            ...
            {
                ql_find_usb_interface_info(devpath, &ql_dev.third_intf);
                if (ql_dev.third_intf.bInterfaceClass != 0xff || ql_dev.third_intf.bInterfaceSubClass != 0xff || ql_dev.third_intf.bInterfaceProtocol != 0x80 || ql_dev.third_intf.bNumEndpoints != 1 || ql_dev.third_intf.ep_out != 0xff || ql_dev.third_intf.ep_in == 0xff)
                {
